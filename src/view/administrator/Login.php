    ...
    <body>        
            ...
            <div class="col-lg-offset-4 col-lg-4">
                ...
                <form id="FrmLogin" method="post" class="jumbotron" action="<?php echo "{$_MyCookie->getSite()}user/login"; ?>">                    
                    ...
                    <div class="input-group input-group-lg">                        
                        ...
                        <a href="#" onclick="$('#mdForgot').modal('show')"><?php _e('Forgot your password', 'administrator') ?>?</a>
                    </div><br>
                    <p class="text-center">
                ...
                <p class="text-center"><a href="#" onclick="$('#mdResend').modal('show'); $('#textEmailRe').focus()">Resend confirmation link.</a></p>
            </div>            
        </div>
        ...
        <div class="modal" id="mdForgot">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php _e('Esqueceu sua senha?', 'administrator') ?></h4>
                    </div>
                    <form name="FrmForgot" id="FrmForgot" role="form" onsubmit="user.forgot(event);">
                        <div class="modal-body">                                        
                            <p>Entre com seu e-mail de cadastro para iniciar o processo de recuperação da senha.</p>
                            <fieldset>                                
                                <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" onclick="$('#mdForgot').modal('hide')"><i class="fa fa-times"></i> <?php _e('Cancel', 'administrator') ?></button>
                            <button type="button" class="btn btn-success" onclick="user.forgot(event)"><i class="fa fa-mail-forward"></i> <?php _e('Enviar', 'administrator') ?></button>
                        </div>
                    </form>
                </div>
            </div>
