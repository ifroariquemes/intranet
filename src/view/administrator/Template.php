                ...
                <div class="col-lg-6 col-sm-6 col-xs-5">
                    <a class="user-info dropdown-toggle" href="#" data-toggle="dropdown">    
                        <div style="float: left">
                            ...
                            <div id="user_completename" class="hidden"><?php echo $_MyCookieUser->getCompleteName() ?></div>
                        </div>
                        <i class="fa fa-4x fa-user"></i>
                    </a>                    
                    <ul id="profile-dropdown" class="dropdown-menu" role="menu">
                        <li><a href="<?php echo $_MyCookie->mountLink('administrator', 'user', 'edit', $_MyCookieUser->getId()) ?>"><?php _e('Edit profile', 'administrator') ?></a></li>                       
                        <li class="divider"></li>
