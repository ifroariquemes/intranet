    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form name="FrmEdit" id="FrmEdit" role="form" onsubmit="banco.submitRetirada(event);">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="numberAulas">Retirar (aulas):</label>                            
                            <input type="number" min="0" max="<?php echo $conta->getSaldo() ?>" required="required" name="aulas" id="numberAulas" class="form-control" value="<?php echo $transacao->getAulas() ?>">                            
                        </div> 
                        <div class="form-group">
